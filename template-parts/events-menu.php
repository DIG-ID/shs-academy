	...
	<div class="container menu__event-container">
		<div class="row">
			<a class="col-6 col-md-6 col-sm-12 px-15 menu__event-link" href="<?php echo get_permalink( get_page_by_path( 'tickets' ) ) ?>">
					...
					<p class="menu__event-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremda</p>
					<p class="menu__event-button">Go to page</p>
			</a>
			<a class="col-6 col-md-6 col-sm-12 px-15 menu__event-link" href="<?php echo get_permalink( get_page_by_path( 'program' ) ) ?>">
		...
		<div class="row menu__event-footer">
			<div class="col-6 col-md-6 col-sm-12 px-15">
				<img class="menu__event-img" src="/shs-academy/wp-content/uploads/2022/02/FooterMenu_SHS.svg" width="210" height="64"><img class="menu__event-img" src="/shs-academy/wp-content/uploads/2022/02/footer-logo-1.svg" width="123" height="64">
			</div>
		</div>
	</div>
</div>
