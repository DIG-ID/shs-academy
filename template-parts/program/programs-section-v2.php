														...
														while ( have_rows( 'block_repeater' ) ) :
															...
															<div class="accordion-item">
																<h2 class="accordion-header" id="flush-heading-<?php echo $e;echo $c; ?>">
																	<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-<?php echo $e;echo $u;echo $c; ?>" aria-expanded="false" aria-controls="flush-collapse-<?php echo $e;echo $u;echo $c; ?>">
																...
																if ( get_sub_field( 'description' ) ) :
																	?>
																	<div id="flush-collapse-<?php echo $e;echo $u;echo $c; ?>" class="accordion-collapse" aria-labelledby="flush-heading-<?php echo $e;echo $c; ?>" data-bs-parent="#programs__accordion-<?php echo $e;echo $u; ?>">
