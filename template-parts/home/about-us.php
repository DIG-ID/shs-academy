	...
	<div class="container container__inside">
		<div class="row align-items-center justify-content-center">
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-6">
				...
				<p class="visitors-number"><span class="number"><?php the_field( 'home_page_settings_about_us_visitors_number' ); ?></span> <?php esc_html_e( 'Visitors', 'shs-a' ); ?></p>
				<a  class="main-btn main-btn__red" href="<?php esc_url( the_field( 'home_page_settings_about_us_button_1_link' ) ); ?>"><?php esc_html_e( 'Tickets kaufen', 'shs-a' ); ?></a>
				<a class="main-btn main-btn__white" href="<?php esc_url( the_field( 'home_page_settings_about_us_button_2_link' ) ); ?>"><?php esc_html_e( 'Mehr erfahren', 'shs-a' ); ?></a>
			</div>
		</div>
	</div>
</section>
