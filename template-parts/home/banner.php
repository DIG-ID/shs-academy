			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-12 col-sm-12 col-md-11 col-lg-8">
						...
						<a class="section-banner__link main-btn main-btn__red" href="<?php esc_url( the_field( 'home_page_settings_banner_button_1_link' ) ); ?>"><?php the_field( 'home_page_settings_banner_button_1_text' ); ?>
