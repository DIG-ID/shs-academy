    ...
    const pointerTracker = new _shared_utils_PointerTracker_js__WEBPACK_IMPORTED_MODULE_4__.PointerTracker(this.$container, {
      start: (pointer, event) => {
        ...
        if (!pointerTracker.currentPointers.length) {
          ...
          if (this.option("textSelection") && (0,_shared_utils_getTextNodeFromPoint_js__WEBPACK_IMPORTED_MODULE_5__.getTextNodeFromPoint)(target, event.clientX, event.clientY)) {
            return false;
          }
        }
...
function swiper($selector, $options) {
  return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]($selector, $options);
}
...
/* harmony import */ var _custom_swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./custom/swiper */ "./src/js/custom/swiper.js");
/* harmony import */ var _custom_fancybox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./custom/fancybox */ "./src/js/custom/fancybox.js");
